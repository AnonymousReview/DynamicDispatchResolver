package com.anonymous.open.jimple.commons.analysis;
...
public class SetDefinitions {
	...
	public static Q JDKLibraries(){
		return com.eanonymous.open.java.commons.analysis.SetDefinitions.JDKLibraries(); 
	}
	...
	public static Q arrayTypes() {
		return com.eanonymous.open.java.commons.analysis.SetDefinitions.arrayTypes();
	}
	...
	public static Q primitiveTypes() {
		return com.eanonymous.open.java.commons.analysis.SetDefinitions.primitiveTypes();
	}
	...
	public static Q libraries() {
		return com.eanonymous.open.java.commons.analysis.SetDefinitions.libraries();
	}
