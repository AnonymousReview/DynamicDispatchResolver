package com.eanonymous.open.java.commons.analysis;
...
public final class CommonQueries {	
	...
	public static GraphElement getGraphElementByAddress(String address){
		return com.anonymous.open.commons.analysis.CommonQueries.getGraphElementByAddress(address);
	}
	...
	public static Node getNodeByAddress(String address){
		return com.anonymous.open.commons.analysis.CommonQueries.getNodeByAddress(address);
	}
	...
	public static Edge getEdgeByAddress(String address){
		return com.anonymous.open.commons.analysis.CommonQueries.getEdgeByAddress(address);
	}
	...
	public static Q localDeclarations(Q origin) {
		return com.anonymous.open.commons.analysis.CommonQueries.localDeclarations(origin);
	}
	...
	public static Q localDeclarations(Q context, Q origin) {
		return com.anonymous.open.commons.analysis.CommonQueries.localDeclarations(context, origin);
	}
	...
	public static Q callers(Q origin) {
		return com.anonymous.open.commons.analysis.CommonQueries.callers(origin);
	}
	...
	public static Q callers(Q context, Q origin) {
		return com.anonymous.open.commons.analysis.CommonQueries.callers(context, origin);
	}
	...
	public static Q called(Q origin) {
		return com.anonymous.open.commons.analysis.CommonQueries.called(origin);
	}
	...
	public static Q called(Q context, Q origin) {
		return com.anonymous.open.commons.analysis.CommonQueries.called(context, origin);
	}
	...
	public static Q calledBy(Q callers, Q called) {
		return com.anonymous.open.commons.analysis.CommonQueries.calledBy(callers, called);
	}
	...
	public static Q calledBy(Q context, Q callers, Q called) {
		return com.anonymous.open.commons.analysis.CommonQueries.calledBy(context, callers, called);
	}
	...
	public static Q cfg(Q functions) {
		return com.anonymous.open.commons.analysis.CommonQueries.cfg(functions);
	}
	...
	public static Q cfg(Node function) {
		return com.anonymous.open.commons.analysis.CommonQueries.cfg(function);
	}
	...
	public static Q firstDeclarator(Q declared, String... declaratorTypes) {
		return com.anonymous.open.commons.analysis.CommonQueries.firstDeclarator(declared, declaratorTypes);
	}
	...
	public static Q firstDeclarator(Q context, Q declared, String... declaratorTypes) {
		return com.anonymous.open.commons.analysis.CommonQueries.firstDeclarator(context, declared, declaratorTypes);
	}
	...
	public static Q advancedIntersection(Q first, Q second, String[] nodeTags, String[] edgeTags) {
		return com.anonymous.open.commons.analysis.CommonQueries.advancedIntersection(first, second, nodeTags, edgeTags);
	}
	...
	public static Q readersOf(Q origin) {
		return com.anonymous.open.commons.analysis.CommonQueries.readersOf(origin);
	}
	...
	public static Q readersOf(Q context, Q origin) {
		return com.anonymous.open.commons.analysis.CommonQueries.readersOf(context, origin);
	}
	...
	public static Q writersOf(Q origin) {
		return com.anonymous.open.commons.analysis.CommonQueries.writersOf(origin);
	}
	...
	public static Q writersOf(Q context, Q origin) {
		return com.anonymous.open.commons.analysis.CommonQueries.writersOf(context, origin);
	}
	...
	public static Q readBy(Q origin) {
		return com.anonymous.open.commons.analysis.CommonQueries.readBy(origin);
	}
	...
	public static Q readBy(Q context, Q origin) {
		return com.anonymous.open.commons.analysis.CommonQueries.readBy(context, origin);
	}
	...
	public static Q writtenBy(Q origin) {
		return com.anonymous.open.commons.analysis.CommonQueries.writtenBy(origin);
	}
	...
	public static Q writtenBy(Q context, Q origin) {
		return com.anonymous.open.commons.analysis.CommonQueries.writtenBy(context, origin);
	}
	...
	public static Node leastCommonAncestor(Node child1, Node child2, Graph graph){
		return com.anonymous.open.commons.analysis.CommonQueries.leastCommonAncestor(child1, child2, graph);
	}
	...
	public static Q getContainingMethods(Q nodes) {
		return com.anonymous.open.commons.analysis.CommonQueries.getContainingFunctions(nodes);
	}
	...
	public static Node getContainingControlFlowNode(Node node) {
		return com.anonymous.open.commons.analysis.CommonQueries.getContainingControlFlowNode(node);
	}
	...
	public static Node getContainingMethod(Node node) {
		return com.anonymous.open.commons.analysis.CommonQueries.getContainingFunction(node);
	}
	...
	public static Node getContainingNode(Node node, String containingTag) {
		return com.anonymous.open.commons.analysis.CommonQueries.getContainingNode(node, containingTag);
	}
	...
	public static Q conditionsAbove(Q origin) {
		return com.anonymous.open.commons.analysis.CommonQueries.conditionsAbove(origin);
	}
	...
	public static Q conditionsAbove(Q context, Q origin) {
		return com.anonymous.open.commons.analysis.CommonQueries.conditionsAbove(context, origin);
	}
	...
	public static Q mutators(Q origin) {
		return com.anonymous.open.commons.analysis.CommonQueries.mutators(origin);
	}
	...
	public static Q nodesWithSelfEdges(Q context) {
		return com.anonymous.open.commons.analysis.CommonQueries.nodesWithSelfEdges(context);
	}
	...
	public static Q mutators(Q context, Q origin) {
		return com.anonymous.open.commons.analysis.CommonQueries.mutators(context, origin);
	}
	...
	public static Q mutatedBy(Q mutators, Q origin) {
		return com.anonymous.open.commons.analysis.CommonQueries.mutatedBy(mutators, origin);
	}
	...
	public static Q mutatedBy(Q context, Q mutators, Q origin) {
		return com.anonymous.open.commons.analysis.CommonQueries.mutatedBy(context, mutators, origin);
	}
	...
	public static String getQualifiedTypeName(Node type) {
		return com.anonymous.open.commons.analysis.CommonQueries.getQualifiedTypeName(type);
	}
	...
	public static String getQualifiedMethodName(Node method) {
		...
		return com.anonymous.open.commons.analysis.CommonQueries.getQualifiedFunctionName(method);
	}
	...
	public static String getQualifiedName(Node node) {
		return com.anonymous.open.commons.analysis.CommonQueries.getQualifiedName(node);
	}
	...
	public static String getQualifiedName(Node node, String...stopAfterTags) {
		return com.anonymous.open.commons.analysis.CommonQueries.getQualifiedName(node, stopAfterTags);
	}
